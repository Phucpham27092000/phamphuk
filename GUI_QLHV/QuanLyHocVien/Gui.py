...
check = tkinter.Label(giaodien, textvariable=SQL, width=20, font=15, bg='DodgerBlue4')
check.grid(column=4, row=12) 

res = tkinter.Label(giaodien, textvariable=Confirm, width=20, font=15, bg='DodgerBlue4')
